...
const BookingPage = ({ data }) => (
    ...
    <Layout data={data}>
        ...
        <div className="main-container">
            ...
            <div className="blackbox"><h1 className="headline1">Newsletter Registration</h1></div>
                <div className="blog-post">
                    <div class="form-iframe-container">
                    <iframe src="http://54499171.swh.strato-hosting.eu/bipolarjs/registration/" name="iframe" id="iframe" scrolling="no" frameborder="0" marginheight="0px" marginwidth="0px" height="422" width="100%" onload="setIframeHeight();"></iframe>
                    </div>
                </div>
            </div>
